...
const SearchFilter = () => {
    ...
    const handleOptionSelection = (option) => { {/*Opçao que seta o valor padrão exibido em cada botão de cada menu dropDown quando o usuario seleciona uma opção */}
                        ...
                        <div className="grid grid-cols-3 gap-4 space-x-8"> {/*1x3 linhas e colunas */}
                            ...
                            <div className="relative"> {/*Filtro de especie de animal */}
                                ...
                                <div id="menuDropDown" className={`inline bg-white border border-gray-300 py-1 shadow-md rounded-md  w-[250px] h-auto absolute text-lg ${menuDrop ? '' : 'hidden'}`}> {/*Menu dropDown da especie dos animais e suas opções(cada link) */}
                                    ...
                                    <button onClick={() => handleOptionSelection('Cachorro')} className="block w-full text-sm text-gray-500 px-3 py-1 bg-white hover:bg-gray-300">Cachorro</button>
                                    <button onClick={() => handleOptionSelection('Gato')} className="block w-full text-sm text-gray-500 px-3 py-1 bg-white hover:bg-gray-300">Gato</button>
                                    <button onClick={() => handleOptionSelection('Todos')} className="block w-full text-sm text-gray-500 px-3 py-1 bg-white hover:bg-gray-300">Todos</button>
                            ...
                            <div className="relative"> {/*Filtro de sexo do animal */}
                                ...
                                <div id="menuDropDown" className={`inline bg-white border border-gray-300 py-1 shadow-md rounded-md  w-[250px] h-auto absolute text-lg ${menuDrop ? '' : 'hidden'}`}> {/*Menu dropDown da especie dos animais e suas opções(cada link) */}
                                    {/*Na div acima, utilizei uma renderização condicional para a classe hidden, ela só vai existir caso o estado do "menuDrop" seja falso, ou seja, so vai esconder
                                    o menuDropDown caso ele não esteja visivel */}
                                    <button onClick={() => handleOptionSelection('Masculino')} className="block w-full text-sm text-gray-500 px-3 py-1 bg-white hover:bg-gray-300">Masculino</button>
                                    <button onClick={() => handleOptionSelection('Feminino')} className="block w-full text-sm text-gray-500 px-3 py-1 bg-white hover:bg-gray-300">Feminino</button>
                                    <button onClick={() => handleOptionSelection('Todos os sexos')} className="block w-full text-sm text-gray-500 px-3 py-1 bg-white hover:bg-gray-300">Todos os sexos</button>
                            ...
                            <div className="relative"> {/*Filtro do porte do animal */}
                                ...
                                <div id="menuDropDown" className={`inline bg-white border border-gray-300 py-1 shadow-md rounded-md  w-[250px] h-auto absolute text-lg ${menuDrop ? '' : 'hidden'}`}> {/*Menu dropDown da especie dos animais e suas opções(cada link) */}
                                    {/*Na div acima, utilizei uma renderização condicional para a classe hidden, ela só vai existir caso o estado do "menuDrop" seja falso, ou seja, so vai esconder
                                    o menuDropDown caso ele não esteja visivel */}
                                    <button onClick={() => handleOptionSelection('Grande')} className="block w-full text-sm text-gray-500 px-3 py-1 bg-white hover:bg-gray-300">Grande</button>
                                    <button onClick={() => handleOptionSelection('Medio')} className="block w-full text-sm text-gray-500 px-3 py-1 bg-white hover:bg-gray-300">Medio</button>
                                    <button onClick={() => handleOptionSelection('Pequeno')} className="block w-full text-sm text-gray-500 px-3 py-1 bg-white hover:bg-gray-300">Pequeno</button>
